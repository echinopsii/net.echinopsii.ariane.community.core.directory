...
package com.spectral.cc.core.directory.base.persistence.iPojo;
...
public class DirectoryJPAProviderImpl implements DirectoryJPAProvider {
    ...
    private static final String DIRECTORY_TXPERSISTENCE_CONSUMER_SERVICE_NAME = "CC Directory JPA Persistence Provider";
