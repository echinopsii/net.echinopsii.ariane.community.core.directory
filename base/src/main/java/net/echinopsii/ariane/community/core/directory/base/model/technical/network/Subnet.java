...
public class Subnet implements Serializable
{
    ...
    public Subnet setDatacentersR(final Set<Location> locations) {
        this.locations = locations;
        return this;
    }
    ...
    public Subnet clone() {
        return new Subnet().setIdR(this.id).setVersionR(this.version).setNameR(this.name).setDescriptionR(this.description).setSubnetIPR(this.subnetIP).
                       setSubnetMaskR(this.subnetMask).setDatacentersR(new HashSet<Location>(this.locations)).setRareaR(this.rarea).
