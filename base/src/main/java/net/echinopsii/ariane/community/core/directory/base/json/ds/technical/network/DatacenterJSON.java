...
public class DatacenterJSON {
    ...
    public final static void datacenter2JSON(Location location, JsonGenerator jgenerator) throws IOException {
        jgenerator.writeStartObject();
        jgenerator.writeNumberField(DC_ID, location.getId());
        jgenerator.writeNumberField(DC_VERSION, location.getVersion());
        jgenerator.writeStringField(DC_NAME, location.getName());
        jgenerator.writeStringField(DC_ADDRESS, location.getAddress());
        jgenerator.writeStringField(DC_TOWN, location.getTown());
        jgenerator.writeNumberField(DC_ZIPCODE, location.getZipCode());
        jgenerator.writeStringField(DC_COUNTRY, location.getCountry());
        jgenerator.writeNumberField(DC_GPSLAT, location.getGpsLatitude());
        jgenerator.writeNumberField(DC_GPSLNG, location.getGpsLongitude());
        jgenerator.writeStringField(DC_DESCRIPTION, location.getDescription());
    ...
    public final static void oneDatacenter2JSON(Location location, ByteArrayOutputStream outStream) throws IOException {
        JsonGenerator jgenerator = DirectoryTreeMenuRootsRegistryImpl.getJFactory().createGenerator(outStream, JsonEncoding.UTF8);
        DatacenterJSON.datacenter2JSON(location, jgenerator);
        jgenerator.close();
    }
